...
const ValidatorSidebar: React.FC<ValidatorSidebarProps> = ({ collapsed = false }) => {
  return (
    <nav className="py-4">
      {!collapsed && (
      ...
      <SidebarSection title="Dashboard" collapsed={collapsed}>
        <SidebarItem icon={BarChart2} title="Dashboard Validasi" to="/admin/validator" collapsed={collapsed} />
      </SidebarSection>

      <SidebarSection title="Validasi" collapsed={collapsed}>
        <SidebarItem icon={FileText} title="Validasi Metadata" to="/admin/validator/metadata" collapsed={collapsed} />
      </SidebarSection>

      <SidebarSection title="Laporan" collapsed={collapsed}>
        <SidebarItem icon={PieChart} title="Statistik Validasi" to="/admin/validator/statistics" collapsed={collapsed} />
      </SidebarSection>

      <SidebarSection title="Akun" collapsed={collapsed}>
        <SidebarItem icon={User} title="Profil Saya" to="/admin/validator/profile" collapsed={collapsed} />
